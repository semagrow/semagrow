...
var YASGUI = function(parent, options) {
    ...
    var addTab = function(tabId) {
        ...
        var tab = require('./tab.js')(yasgui, tabId, name, endpoint);
        yasgui.tabs[tabId] = tab;

        tab.on('query', function() { $tabItem.addClass('querying');  });
        tab.on('queryFinish', function() { $tabItem.removeClass('querying'); });
...
module.exports.YASQE = require('yasgui-yasqe');
module.exports.YASR = require('yasgui-yasr');
module.exports.$ = $;
