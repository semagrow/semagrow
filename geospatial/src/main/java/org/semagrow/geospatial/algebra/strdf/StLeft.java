...
public class StLeft implements Function {
	
    @Override
    public String getURI() {
        return STRDF.left.toString();
    }
    ...
    public Value evaluate(ValueFactory valueFactory, Value... values) throws ValueExprEvaluationException {
        ...
        boolean left = SimpleGeometryCoordinates.maxX(mbb1) < SimpleGeometryCoordinates.minX(mbb2);
        Value value = valueFactory.createLiteral(left);
        return value;
    }
}
