 ...
 */
public class SimpleEquivalentIRI implements EquivalentIRI {
    ...
    public SimpleEquivalentIRI(IRI source, IRI target, IRI sourceSchema, IRI targetSchema, int proximity, int transformationID) {
        this.source = source;
        this.target = target;
